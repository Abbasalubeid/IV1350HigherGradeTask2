package se.kth.iv1350.additionalHigherGradeTask2.composition;

import java.util.Date;

import se.kth.iv1350.additionalHigherGradeTask2.InvalidNumberException;
 ...
 *
 */
public class DateAdaptionByComposition {
	...
	private int hoursDifference(int hourToCompare) throws InvalidNumberException {
		...
		return Math.abs(date.getHours() - hourToCompare);
	...
	private int minutesDifference(int minuteToCompare) throws InvalidNumberException {
		...
		return Math.abs(date.getMinutes() - minuteToCompare);
	...
	private int secondsDifference(int secondToCompare) throws InvalidNumberException {
		...
		return Math.abs(date.getSeconds() - secondToCompare);
	...
	private int dateDifference(int dateToCompare) throws InvalidNumberException {
		...
		return Math.abs(date.getDate() - dateToCompare);
